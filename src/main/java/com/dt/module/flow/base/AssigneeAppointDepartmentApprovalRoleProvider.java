...
@Component
public class AssigneeAppointDepartmentApprovalRoleProvider implements AssigneeProvider {

    private static Logger log = LoggerFactory.getLogger(AssigneeAppointDepartmentApprovalRoleProvider.class);
    ...
    public static String info="指定-动态部门角色";
