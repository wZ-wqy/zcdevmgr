 ...
 */
@Controller
@RequestMapping("/api/ops/opsRackInfo")
public class OpsRackInfoController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(OpsRackInfoServiceImpl.removeById(id));
	}
	...
	public R selectById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(OpsRackInfoServiceImpl.getById(id));
	}

	@ResponseBody
	@Acl(info = "插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insert.do")
	public R insert(OpsRackInfo entity) {
		return R.SUCCESS_OPER(OpsRackInfoServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(OpsRackInfo entity) {
		return R.SUCCESS_OPER(OpsRackInfoServiceImpl.updateById(entity));
	}
	...
	public R insertOrUpdate(OpsRackInfo entity) {
		return R.SUCCESS_OPER(OpsRackInfoServiceImpl.saveOrUpdate(entity));
	}
	...
	public R selectList() {
		return R.SUCCESS_OPER(OpsRackInfoServiceImpl.list(null));
	}
	...
	public R selectPage(String start, String length, @RequestParam(value = "pageSize", required = true, defaultValue = "10")  String pageSize,@RequestParam(value = "pageIndex", required = true, defaultValue = "1")  String pageIndex) {
		...
		QueryWrapper<OpsRackInfo> ew = new QueryWrapper<OpsRackInfo>();
		//ew.and(i -> i.eq("user_id", getUserId()).apply(pagesize>10, "rtime>sysdate-1","23"));
		IPage<OpsRackInfo> pdata = OpsRackInfoServiceImpl.page(new Page<OpsRackInfo>(pageindex, pagesize), ew);
