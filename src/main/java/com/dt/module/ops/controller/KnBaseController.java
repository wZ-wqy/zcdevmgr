 ...
 */
@Controller
@RequestMapping("/api/ops/knBase")
public class KnBaseController extends BaseController {
	...
	public R deleteById(@RequestParam(value = "id", required = true, defaultValue = "") String id) {
		return R.SUCCESS_OPER(KnBaseServiceImpl.removeById(id));
	}
	...
	public R insert(KnBase entity) {
		return R.SUCCESS_OPER(KnBaseServiceImpl.save(entity));
	}

	@ResponseBody
	@Acl(info = "根据Id更新", value = Acl.ACL_USER)
	@RequestMapping(value = "/updateById.do")
	public R updateById(KnBase entity) {
		return R.SUCCESS_OPER(KnBaseServiceImpl.updateById(entity));
	}

	@ResponseBody
	@Acl(info = "存在则更新,否则插入", value = Acl.ACL_USER)
	@RequestMapping(value = "/insertOrUpdate.do")
	public R insertOrUpdate(KnBase entity) {
	...
	public R selectList() {
		return R.SUCCESS_OPER(KnBaseServiceImpl.list(null));
	}
